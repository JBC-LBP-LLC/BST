...
module resource_group '../../Bicep/resource_group.bicep' = {
  name: 'name'
  params: {
...
module container_registry '../../Bicep/container_registry.bicep' = {
  ...
  params: {
    ...
    //public_network_access: 'Enabled' // 'Enabled' or 'Disabled'
    //network_rules: { 
      //default_action: 'Allow' // 'Allow' or 'Deny'
      //ip_rules: [ 
        //{ 
          //ip_address: '$public_ip_address' // '$public_ip_address' or '*'
...
module data_bricks '../../Bicep/data_bricks.bicep' = {
  name: 'data_bricks'
  scope: resource_group
  params: {
...
module kubernetes_service '../../Bicep/kubernetes_service.bicep' = {
...
module postgres_flex_server '../../Bicep/postgres_flex_server.bicep' = {
...
module redis_cache '../../Bicep/redis_cache.bicep' = {
  name: 'redis_cache'
  scope: resource_group
  params: {
...
module storage_account '../../Bicep/storage_account.bicep' = {
